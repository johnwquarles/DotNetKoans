...
namespace DotNetKoans.CSharp
{
    public class AboutControlStatements : Koan
    {
        ...
        public void AssignIfNullOperator()
        {
            ...
            // # left if it isn't null, right if it is.
        ...
        public void CatchingModificationExceptions()
        {
            ...
            // # maybe exception is thrown when you get to an item for which the index wasn't in the originally specified range (ie, when i gets larger than the original length (minus one technically)).
