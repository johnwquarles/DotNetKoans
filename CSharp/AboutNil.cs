...
namespace DotNetKoans.CSharp
{
    public class AboutNil : Koan
    {
        ...
        {
            object obj = null;
            // I assume that the point being made here is that you can't call a method on null, hence this method of checking for null doesn't work.
            // so it should throw an error like it did in the beginning of koan 2.
